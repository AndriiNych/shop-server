...
@Controller(TABLE_NAMES.menu_description)
export class MenuDescriptionController {
  constructor(private readonly menuDescriptionService: MenuDescriptionService) {}
  // @Get('/')
