...
@Controller(TABLE_NAMES.product_stickers)
export class ProductStickersController {
  constructor(private readonly productStickersService: ProductStickersService) {}
  // @Get('/')
